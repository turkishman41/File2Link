...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'dl2.dto41.ir'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'dl2.dto41.ir:34')) if not ON_HEROKU or getenv('FQDN', 'dl2.dto41.ir:34') else APP_NAME+'.herokuapp.com'
